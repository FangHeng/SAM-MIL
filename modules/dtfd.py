...
class DimReduction(nn.Module):
    def __init__(self, n_channels, m_dim=512, dropout=False, act="relu"):
...
class DTFD(nn.Module):
    def __init__(self, lr, weight_decay, steps, criterion, input_dim=1024, inner_dim=512, n_classes=2, group=8, distill="MaxMinS") -> None:
        super().__init__()
