...
class DAttention(nn.Module):
    ...
    def forward(self, x, return_attn=False,no_norm=False,return_act=False):
...
class DSMIL(nn.Module):
    ...
    def attention(self,x,no_norm=False,return_attn=False):
        ps = x.size(1)
        feats = x.squeeze(0)
...
class SAttention(nn.Module):
    ...
    def forward(self, x, return_attn=False,return_act=False):
