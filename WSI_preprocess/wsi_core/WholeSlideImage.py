...
#         self.name = ".".join(path.split("/")[-1].split('.')[:-1])
    ...
    def process_contour(self, cont, contour_holes, patch_level, save_path_hdf5, save_path_segments, patch_size=256,
                        step_size=256, use_sam=False, sam_model=None, min_mask_region_area=0,
        ...
        if len(results) > 0:
            ...
            return asset_dict, attr_dict, filtered_masks
